...
https://api.nasa.gov/neo/rest/v1/neo/3726712?api_key={m2u3zxriUlYvSM3p4OzFXDKUh7DgVsSiwyM1rAcY}
'''
...
def get_comet_data(api_key):
    ...
    url = f"https://api.nasa.gov/neo/rest/v1/neo/3726710?api_key={m2u3zxriUlYvSM3p4OzFXDKUh7DgVsSiwyM1rAcY}"
